...
SDLK_LALT,SDLK_LSHIFT,SDLK_LCTRL,SDLK_SPACE,SDLK_TAB,SDLK_BACKSPACE,SDLK_PAGEUP,SDLK_PAGEDOWN,SDLK_ESCAPE,SDLK_RETURN,SDLK_RCTRL
};
#elif defined(RETROFW)
static const SDLKey sd_keyb[19]={SDLK_UP,SDLK_e,SDLK_RIGHT,SDLK_c,SDLK_DOWN,SDLK_z,SDLK_LEFT,SDLK_q,
SDLK_LCTRL,SDLK_SPACE,SDLK_LALT,SDLK_LSHIFT,SDLK_TAB,SDLK_BACKSPACE,SDLK_PAGEUP,SDLK_PAGEDOWN,SDLK_ESCAPE,SDLK_RETURN,SDLK_RCTRL
};
#else
